...
contract OHMSale {
    ...
    //     require(!isInvestor[msg.sender],"investor");
    //     IERC20(baseToken).transferFrom(msg.sender, address(this), MAX_NUMBER * PRICE *  10 ** (ERC20(baseToken).decimals()));
    //     isInvestor[msg.sender] = true;
    //     IERC20(farmingToken).transfer(msg.sender, MAX_NUMBER * 10 ** (ERC20(farmingToken).decimals()));
    // }
