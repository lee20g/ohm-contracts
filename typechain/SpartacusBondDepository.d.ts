...
interface SpartacusBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class SpartacusBondDepository extends BaseContract {
  ...
  interface: SpartacusBondDepositoryInterface;
