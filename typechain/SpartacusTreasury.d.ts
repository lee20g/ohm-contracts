...
interface SpartacusTreasuryInterface extends ethers.utils.Interface {
  functions: {
...
export class SpartacusTreasury extends BaseContract {
  ...
  interface: SpartacusTreasuryInterface;
