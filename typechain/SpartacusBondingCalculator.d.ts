...
interface SpartacusBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class SpartacusBondingCalculator extends BaseContract {
  ...
  interface: SpartacusBondingCalculatorInterface;
