...
interface SpartacusStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class SpartacusStaking extends BaseContract {
  ...
  interface: SpartacusStakingInterface;
