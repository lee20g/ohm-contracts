...
interface PriceTestInterface extends ethers.utils.Interface {
  functions: {
    "bondPriceInUSDTest(address,address,uint256,uint256,uint256)": FunctionFragment;
    "bondPriceTest(uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "bondPriceInUSDTest",
    values: [string, string, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "bondPriceTest",
...
export class PriceTest extends BaseContract {
