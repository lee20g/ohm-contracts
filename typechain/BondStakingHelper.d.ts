...
interface BondStakingHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class BondStakingHelper extends BaseContract {
  ...
  interface: BondStakingHelperInterface;
