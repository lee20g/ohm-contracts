...
interface SpartacusERC20TokenInterface extends ethers.utils.Interface {
  functions: {
...
export class SpartacusERC20Token extends BaseContract {
  ...
  interface: SpartacusERC20TokenInterface;
